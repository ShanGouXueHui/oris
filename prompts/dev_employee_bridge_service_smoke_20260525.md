# ORIS Bridge Service Smoke Prompt — 2026-05-25

You are ORIS / OpenClaw / Codex-backed AI Dev Employee. This task is executed by the host supervised bridge service.
...
- `/home/admin/projects/oris/logs/dev_employee/bridge_service_smoke_py_compile_20260525.txt`
- `/home/admin/projects/oris/logs/dev_employee/bridge_service_smoke_pytest_20260525.txt`
- `/home/admin/projects/oris/logs/dev_employee/bridge_service_smoke_pytest_werror_20260525.txt`

## Required structured result

After local checks pass, write:

`/home/admin/projects/oris/orchestration/task_runs/bridge-service-smoke-20260525.codex_result.json`

with JSON:

```json
{
  "task_id": "bridge-service-smoke-20260525",
  "status": "local_checks_passed",
  "product_path": "/home/admin/projects/oris-final-acceptance-api",
  "changed_files": [],
  "check_logs": {
    "py_compile": "/home/admin/projects/oris/logs/dev_employee/bridge_service_smoke_py_compile_20260525.txt",
    "pytest": "/home/admin/projects/oris/logs/dev_employee/bridge_service_smoke_pytest_20260525.txt",
    "pytest_werror": "/home/admin/projects/oris/logs/dev_employee/bridge_service_smoke_pytest_werror_20260525.txt"
  },
  "notes": "Local smoke checks passed; outer supervised bridge must verify host checks, push if needed, verify remote, and update ORIS evidence."
}
```
