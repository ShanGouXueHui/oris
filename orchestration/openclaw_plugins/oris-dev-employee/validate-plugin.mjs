...
assert.equal(typeof plugin.register, "function", "mixed plugin register handler must be present");
assert.ok(plugin.configSchema, "mixed plugin config schema must be present");
