...
python3 -m compileall -q oris_vnext scripts/dev_employee_smoke.py scripts/dev_employee_codex_gate_smoke.py scripts/dev_employee_ledger_event_smoke.py >> "$VALIDATION_FILE" 2>&1
COMPILE_RC=$?
...
git add "$SUMMARY_FILE" "$VALIDATION_FILE" .gitignore scripts/dev_employee_cycle.sh config/dev_employee_runtime.json scripts/dev_employee_smoke.py scripts/dev_employee_codex_gate_smoke.py scripts/dev_employee_ledger_event_smoke.py oris_vnext/bootstrap_reader.py oris_vnext/validation.py oris_vnext/codex_executor.py oris_vnext/ledger_events.py 2>> "$COMMIT_LOG_FILE"
COMMIT_RC=0
PUSH_RC=0
