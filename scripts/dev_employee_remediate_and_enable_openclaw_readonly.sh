...
summary() {
  ...
  echo "ROUTING_SKILL_RUNTIME_VISIBLE=$(summary_value "$ENABLEMENT_OUT" ROUTING_SKILL_RUNTIME_VISIBLE NO)"
  echo "ROUTING_SKILL_AGENT=$(summary_value "$ENABLEMENT_OUT" ROUTING_SKILL_AGENT '')"
  echo "TELEMETRY_AFTER_TOOL_CALL_COUNT=$(summary_value "$ENABLEMENT_OUT" TELEMETRY_AFTER_TOOL_CALL_COUNT 0)"
